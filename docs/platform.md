...
headers, mime types, and timings; query strings, cookies, credentials, and
bodies omitted; Firefox/WebKit HTTPS versions stay `unknown` without Resource
Timing), Playwright trace, and WARC
